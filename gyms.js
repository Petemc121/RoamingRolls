...
const extraInfoEdit = document.getElementById('editExtra');
...
extraInfoEdit.addEventListener('click', () => {
    extraInput.style.display = "block";
    extraOutput.style.display = "none";
    extraSubmit.style.display = "block";
    extraCancel.style.display = "block";
})

extraCancel.addEventListener('click', () => {
  extraInput.style.display = "none";
  extraOutput.style.display = "block";
  extraSubmit.style.display = "none";
  extraCancel.style.display = "none";
})
